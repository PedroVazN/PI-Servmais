...
import AreaFrila from './componentes/AreaFrila';
import GestaoPods from './componentes/GestaoPods';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/AreaFrila" element={<AreaFrila />} />
        <Route path="/AreaUser" element={<AreaUser />} />
        <Route path="/GestaoPods" element={<GestaoPods />} />        
      </Routes>
    </>
  );
}
